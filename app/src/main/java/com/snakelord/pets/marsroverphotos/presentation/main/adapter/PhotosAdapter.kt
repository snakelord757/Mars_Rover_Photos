...
class PhotosAdapter(private val photos: Array<Photo>) : RecyclerView.Adapter<ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
       return when (viewType) {
           PHOTO -> PhotoViewHolder(LayoutInflater.from(parent.context)
               .inflate(R.layout.item_photo, parent, false))
           EMPTY_LIST -> EmptyListViewHolder(LayoutInflater.from(parent.context)
